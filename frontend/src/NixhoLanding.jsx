    ...
    <div className="flex justify-between items-center px-8 py-4 w-full max-w-7xl mx-auto">
      ...
      <div className="flex items-center gap-4">
        <button
          ...
          className="text-slate-600 text-sm font-semibold tracking-tight px-4 py-2 hover:text-indigo-500 transition-colors"
        >
          Student Login
        </button>
        <button
  ...
  <section className="max-w-7xl mx-auto px-8 py-16 md:py-24">
    <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
      ...
      <div className="space-y-8">
        ...
        >
          Accelerate your technical journey with Profe++'s AI-powered
    ...
    <div className="max-w-7xl mx-auto px-8">
      <div className="text-center mb-16 space-y-4">
        ...
        <p
          ...
          style={{ color: colors.onSurfaceVariant }}
        >
          Traditional bootcamps overwhelm. Profe++ prioritizes clarity through
            ...
            >
              ...
              >
                ...
                <div className="flex gap-2">
                  ...
                  <span className="pl-4">
                    const config = new ProfePlusConfig();
                  </span>
                </div>
                <div className="flex gap-2">
  ...
  >
    <div className="flex flex-col md:flex-row justify-between items-center px-12 py-12 w-full max-w-7xl mx-auto">
      <div className="mb-8 md:mb-0">
        <span className="text-lg font-black text-slate-900">Profe++</span>
